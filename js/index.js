...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartona += `
        <div class="col-md-3">
                <div onclick="getMealDetails('${arr[i].idMeal}')" class="meal cursor-pointer position-relative overflow-hidden rounded-2">
...
function displayCategories(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartona += `
        <div class="col-md-3">
                <div onclick="getCategoryMeals('${arr[i].strCategory}')" class="meal cursor-pointer position-relative overflow-hidden rounded-2">
...
function displayArea(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartona += `
        <div class="col-md-3">
                <div onclick="getAreaMeals('${arr[i].strArea}')" class="cursor-pointer rounded-2 text-center">
...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartona += `
        <div class="col-md-3">
                <div onclick="getIngredientsMeals('${arr[i].strIngredient}')" class="cursor-pointer rounded-2 text-center">
...
function ageValidation() {
    return (/^((0|[1-9])?[1-9][0-9]|[1][1-9][1-9]|120)$/.test(document.getElementById("ageInput").value))
}
